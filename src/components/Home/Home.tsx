    ...
    return (
        <>
            <main className="home-main">
                ...
                </section> <div>Follow us on social media! <img className="sm-icon" src="https://imgs.search.brave.com/PtT84CPJXMQ7jJQ4DaeBik5PoLhi1JXN-kGR5vOVurM/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9jbGlw/YXJ0LWxpYnJhcnku/Y29tL25ld19nYWxs/ZXJ5LzUtNTQ3MTBf/ZmItaWNvbi1wbmct/ZmFjZWJvb2stbG9n/by1ncmV5LWNpcmNs/ZS5wbmc" alt="facebook"/>
                ...
                <section className="info">
                    <div className="text">Something for everyone</div>
                    <button className="btn-menu-view" onClick={scrollToTop}><Link to="./menu#top">View Menu</Link></button>
                </section>
